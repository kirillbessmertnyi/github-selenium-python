...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiUserLicenseAssignment,
) -> Dict[str, Any]:
    url = "{}/api/System/User/{userId}/License".format(client.base_url, userId=user_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Assigne license
     ...
     Assigne license to the user with the specified *userId*.

    Args:
        user_id (int):
        json_body (ApiUserLicenseAssignment): The user license assignment information.
