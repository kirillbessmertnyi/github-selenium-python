...
from ...models.system_change_user_photo_multipart_data import SystemChangeUserPhotoMultipartData
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: SystemChangeUserPhotoMultipartData,
) -> Dict[str, Any]:
    url = "{}/api/System/User/{userId}/Photo".format(client.base_url, userId=user_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Upload user picture
     ...
     Upload picture that replaces profile photo of the user with the specified *userId*.
