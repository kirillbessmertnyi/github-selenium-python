...
from ...models.api_long_operation_patch_operation import ApiLongOperationPatchOperation
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiLongOperationPatchOperation,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Modify long operation
     ...
     Performs modification of a long operation identified by given guid.

    Args:
        guid (Optional[str]):
        json_body (ApiLongOperationPatchOperation): Represents patch operation that modifies 'long
            operation'.
