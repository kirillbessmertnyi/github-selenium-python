...
from ...models.api_custom_notification_new import ApiCustomNotificationNew
...
def _get_kwargs(
    *,
    ...
    json_body: ApiCustomNotificationNew,
) -> Dict[str, Any]:
    url = "{}/api/System/NotifyUsers".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Send email notification
     ...
     Sends custom email notification to given users.
                Warning! Allows to send notification to \"known\" users only i.e. users that are
    assigned
                to projects where current user is assigned.

    Args:
        json_body (ApiCustomNotificationNew): A new email notification to be send to given users.
