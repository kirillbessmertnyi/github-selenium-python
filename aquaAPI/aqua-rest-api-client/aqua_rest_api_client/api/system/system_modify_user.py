...
from ...models.api_user_patch_request import ApiUserPatchRequest
...
def sync_detailed(
    ...
    *,
    ...
    """Modify user
     ...
     Modify the user with the specified *userId*.

    Args:
        user_id (int):
        json_body (ApiUserPatchRequest): Represent a request to modify a user.
