...
from ...models.api_role_patch_request import ApiRolePatchRequest
...
def sync_detailed(
    ...
    *,
    ...
    """Modify role
     ...
     Modify the role with the specified *roleId*.

    Args:
        role_id (int):
        json_body (ApiRolePatchRequest): Represent a request to modify a role.
