...
def _get_kwargs(
    ...
    *,
    ...
    params: Dict[str, Any] = {}
    json_object_types: Union[Unset, None, List[int]] = UNSET
...
def sync_detailed(
    ...
    *,
    ...
    """Information for Excel import file
     ...
     Creates a template with information about the properties to import and worksheet information

    Args:
        project_id (int):
        folder_id (int):
        object_types (Union[Unset, None, List[ObjectType]]):
