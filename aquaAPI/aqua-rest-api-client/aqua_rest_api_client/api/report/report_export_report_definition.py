...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Report/Definition/{reportId}/Transfer".format(client.base_url, reportId=report_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Get report
     ...
     Get content (.arp file) of the report definition with the given *reportId*.
