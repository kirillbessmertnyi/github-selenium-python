...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/DashboardNG/{dashboardId}/Widget/{widgetId}/Preview".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create widget preview
     ...
     Create data preview of the widget with the given *widgetId* according to criteria send in the
    request. The criteria do have to be persisted.
    This allows to perform a \"preview\" of widget with changed configuration before actually persisting
    it.
