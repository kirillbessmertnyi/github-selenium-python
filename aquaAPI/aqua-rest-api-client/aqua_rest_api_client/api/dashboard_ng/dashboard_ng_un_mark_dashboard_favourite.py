...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/DashboardNG/{dashboardId}/Favourite".format(client.base_url, dashboardId=dashboard_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Remove favourite
     ...
     Remove dashboard with the given *dashboardId* from favourites of current user (i.e. the dashboard
    will no longer be included on the list of favourites).
