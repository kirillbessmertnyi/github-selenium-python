...
def sync_detailed(
    ...
    *,
    ...
    """Update dashboard
     ...
     Allows to update the dashboard with the given *dashboardId*.
    Widgets and ProjectShares collections are updated only if they are present in the received data -
    sending
    ...
    Returns:
        Response[Union[ApiArgumentError, ApiBackendNotAvailableError, ApiDashboardNG, ApiForbiddenError, ApiInternalError, ApiNotFoundError, ApiUnauthorizedError]]
    """
