...
from ...models.test_case_add_attachment_multipart_data import TestCaseAddAttachmentMultipartData
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: TestCaseAddAttachmentMultipartData,
...
def sync_detailed(
    ...
    *,
    ...
    """Create attachment
     ...
     Create a new attachment with the given *filename* in the test case with
