...
from ...models.api_item_update_with_test_data_and_test_steps import ApiItemUpdateWithTestDataAndTestSteps
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiItemUpdateWithTestDataAndTestSteps,
...
def sync_detailed(
    ...
    *,
    ...
    """Update test case
     ...
     Update the test case with the specified *id*. The changes
