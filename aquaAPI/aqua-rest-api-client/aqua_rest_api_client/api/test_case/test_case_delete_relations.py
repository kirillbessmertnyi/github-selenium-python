...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/TestCase/{id}/Relation/{relationId}".format(client.base_url, id=id, relationId=relation_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Delete relation
     ...
     Delete relation of the test case with the given *id* and *relationId*.
