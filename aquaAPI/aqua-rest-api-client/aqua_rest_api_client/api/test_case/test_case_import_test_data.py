...
from ...models.test_case_import_test_data_multipart_data import TestCaseImportTestDataMultipartData
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: TestCaseImportTestDataMultipartData,
...
def sync_detailed(
    ...
    *,
    ...
    """Import test data
     ...
     Import test data for this test case from the provided file. The content of the
