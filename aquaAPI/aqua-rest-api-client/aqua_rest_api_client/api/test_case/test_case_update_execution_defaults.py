...
from ...models.api_test_case_execution_defaults_update import ApiTestCaseExecutionDefaultsUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiTestCaseExecutionDefaultsUpdate,
) -> Dict[str, Any]:
    url = "{}/api/TestCase/{id}/ExecutionDefaults".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Update test case execution defaults
     ...
     Update the test case execution defaults for the specified test case *id*.
