...
from ...models.script_add_attachment_multipart_data import ScriptAddAttachmentMultipartData
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: ScriptAddAttachmentMultipartData,
...
def sync_detailed(
    ...
    *,
    ...
    """Create attachment
     ...
     Create a new attachment with the given *filename* in the script with
