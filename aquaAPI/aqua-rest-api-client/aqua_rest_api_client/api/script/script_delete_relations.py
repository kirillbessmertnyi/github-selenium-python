...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Script/{id}/Relation/{relationId}".format(client.base_url, id=id, relationId=relation_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Delete relation
     ...
     Delete relation of the script with the given *id* and *relationId*.
