...
from ...models.api_script import ApiScript
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Script/{id}".format(client.base_url, id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = ApiScript.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ApiBackendNotAvailableError, ApiForbiddenError, ApiInternalError, ApiNotFoundError, ApiScript, ApiUnauthorizedError]]
    """
