...
from ...models.api_item_update_with_description import ApiItemUpdateWithDescription
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiItemUpdateWithDescription,
...
def sync_detailed(
    ...
    *,
    ...
    """Update requirement
     ...
     Update the requirement with the specified id. The changes
