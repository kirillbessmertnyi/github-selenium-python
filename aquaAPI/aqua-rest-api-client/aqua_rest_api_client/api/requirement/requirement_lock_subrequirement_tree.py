...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Requirement/{id}/SubrequirementTree/Lock".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Create subrequirment locks
     ...
     Create locks for all subrequirements of the requirement with the given *id* for editing
                which can be locked by the current user. This depends on whether the user has edit
    permission
