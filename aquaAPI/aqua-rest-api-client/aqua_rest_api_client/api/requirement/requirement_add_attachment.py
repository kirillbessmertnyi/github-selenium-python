...
from ...models.requirement_add_attachment_multipart_data import RequirementAddAttachmentMultipartData
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: RequirementAddAttachmentMultipartData,
...
def sync_detailed(
    ...
    *,
    ...
    """Create attachment
     ...
     Create a new attachment with the given *filename* in the requirement with
