...
from ...models.api_batch_operation import ApiBatchOperation
...
def sync_detailed(
    *,
    ...
    """Modify requirement collection
     ...
     Perform a batch operation with all the requirements
                specified in the batch operation.

    Args:
        json_body (ApiBatchOperation): Represents a batch operation. A batch operation performs
