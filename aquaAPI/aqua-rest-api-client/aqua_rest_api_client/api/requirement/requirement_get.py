...
from ...models.api_requirement import ApiRequirement
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Requirement/{id}".format(client.base_url, id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = ApiRequirement.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Get requirement
     ...
     Get the requirement with the specified id.
    ...
    Returns:
        Response[Union[ApiBackendNotAvailableError, ApiForbiddenError, ApiInternalError, ApiNotFoundError, ApiRequirement, ApiUnauthorizedError]]
    """
