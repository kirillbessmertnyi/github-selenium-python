...
from ...models.api_item_new_with_description import ApiItemNewWithDescription
...
def _get_kwargs(
    *,
    ...
    json_body: ApiItemNewWithDescription,
...
def sync_detailed(
    *,
    ...
    """Create requirement
     ...
     Create a new requirement with the given data and returns some basic information on
                the new requirement.
