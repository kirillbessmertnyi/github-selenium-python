...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Requirement/{id}/Relation/{relationId}".format(client.base_url, id=id, relationId=relation_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Delete relation
     ...
     Delete relation of the requirement with the given *id* and *relationId*.
