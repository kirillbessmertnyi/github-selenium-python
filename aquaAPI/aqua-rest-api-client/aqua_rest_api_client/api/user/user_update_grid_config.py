...
def sync_detailed(
    ...
    *,
    ...
    """Replace grid config
     ...
     Replace the grid config for the given *projectId* and *itemType*. Any invalid data is silently
    ignored.
    ...
    Args:
        ...
        item_type (ApiItemType): Identifies the type of item.
            This enum has the following values:
              ...
              - `TestExecution`
              - `TestScenario`
        json_body (ApiGridConfig): The configuration of the item grid for a specific
