...
from ...models.api_project_folder_favourite_patch import ApiProjectFolderFavouritePatch
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiProjectFolderFavouritePatch,
) -> Dict[str, Any]:
    url = "{}/api/User/FolderFavourite/{id}".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Update folder favourite
     ...
     Allows to update the folder favourite with the given *id*.

    Args:
        id (int):
        json_body (ApiProjectFolderFavouritePatch): Represents data required to execute operation
            that modifies folder favourite.
