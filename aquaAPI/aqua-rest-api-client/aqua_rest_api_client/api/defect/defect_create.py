...
from ...models.api_item_new_with_enclosures import ApiItemNewWithEnclosures
...
def _get_kwargs(
    *,
    ...
    json_body: ApiItemNewWithEnclosures,
...
def sync_detailed(
    *,
    ...
    """Create defect
     ...
     Create a new defect with the given data and returns some basic information on
                the new defect.
