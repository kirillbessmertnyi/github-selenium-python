...
from ...models.api_item_update_with_enclosures import ApiItemUpdateWithEnclosures
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiItemUpdateWithEnclosures,
...
def sync_detailed(
    ...
    *,
    ...
    """Update defect
     ...
     Update the defect with the specified id. The changes
