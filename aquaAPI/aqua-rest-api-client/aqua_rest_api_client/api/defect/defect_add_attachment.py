...
from ...models.defect_add_attachment_multipart_data import DefectAddAttachmentMultipartData
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: DefectAddAttachmentMultipartData,
...
def sync_detailed(
    ...
    *,
    ...
    """Create attachment
     ...
     Create a new attachment. The attachment's content can be provided directly in the request body
