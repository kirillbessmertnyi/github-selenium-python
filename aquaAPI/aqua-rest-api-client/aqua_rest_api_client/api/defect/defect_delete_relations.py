...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Defect/{id}/Relation/{relationId}".format(client.base_url, id=id, relationId=relation_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Delete relation
     ...
     Delete relation of the defect with the given id and relationId.
