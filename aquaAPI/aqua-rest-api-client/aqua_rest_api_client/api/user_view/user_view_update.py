...
from ...models.api_user_view_update import ApiUserViewUpdate
...
def sync_detailed(
    ...
    *,
    ...
    """Update user view
     ...
     Allows to update the user view with the given *userViewId*.

    Args:
        user_view_id (int):
        json_body (ApiUserViewUpdate): Contains necessary information for the user view update.
