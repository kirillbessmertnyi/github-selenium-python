...
from ...models.api_config_element_patch_operation import ApiConfigElementPatchOperation
...
def _get_kwargs(
    *,
    ...
    json_body: ApiConfigElementPatchOperation,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Modify my config elements
     ...
     Modify matching config elements for current user according to patch operation.
