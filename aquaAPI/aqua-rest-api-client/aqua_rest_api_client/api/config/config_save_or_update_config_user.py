...
from ...models.api_config_element_save import ApiConfigElementSave
...
def _get_kwargs(
    *,
    ...
    json_body: ApiConfigElementSave,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Replace my config elements
     ...
     Replace config elements for the current user.
    ...
    Returns:
        Response[Union[ApiArgumentError, ApiBackendNotAvailableError, ApiConfigElement, ApiForbiddenError, ApiInternalError, ApiNotFoundError, ApiUnauthorizedError]]
    """
