...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Integration/Effective/{projectId}".format(client.base_url, projectId=project_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Get effective project configurations
     ...
     Get effective integration configurations for the project with the given projectId.
    ...
    Returns:
        Response[Union[ApiArgumentError, ApiBackendNotAvailableError, ApiForbiddenError, ApiIntegrationConfigurations, ApiInternalError, ApiUnauthorizedError]]
    """
