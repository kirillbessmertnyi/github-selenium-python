...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Integration/Configuration/Project/{projectId}".format(client.base_url, projectId=project_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Get project configurations
     ...
     Get the integration configurations for the project with the given projectId.
    ...
    Returns:
        Response[Union[ApiBackendNotAvailableError, ApiForbiddenError, ApiIntegrationConfigurations, ApiInternalError, ApiUnauthorizedError]]
    """
