...
from ...models.api_integration_enable import ApiIntegrationEnable
...
def _get_kwargs(
    *,
    ...
    json_body: ApiIntegrationEnable,
) -> Dict[str, Any]:
    url = "{}/api/Integration/Enable".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Enable
     ...
     Allows for enabling or disabling an integration

    Args:
        json_body (ApiIntegrationEnable): The body for the integration enable request
