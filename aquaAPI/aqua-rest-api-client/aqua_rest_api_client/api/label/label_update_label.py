...
from ...models.api_label_update import ApiLabelUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiLabelUpdate,
) -> Dict[str, Any]:
    url = "{}/api/Label/{id}".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        json_body (ApiLabelUpdate): Represents a new label.
