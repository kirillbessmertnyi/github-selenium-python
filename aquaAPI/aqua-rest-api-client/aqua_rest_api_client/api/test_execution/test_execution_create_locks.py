...
from ...models.api_test_execution_create_lock import ApiTestExecutionCreateLock
...
def _get_kwargs(
    *,
    ...
    json_body: List["ApiTestExecutionCreateLock"],
) -> Dict[str, Any]:
    url = "{}/api/TestExecution/Lock".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Create locks
     ...
     Create locks for the given test executions for exclusive editing.
