...
from ...models.api_project_subfolders_patch_operation import ApiProjectSubfoldersPatchOperation
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiProjectSubfoldersPatchOperation,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Modify subfolder collection
     ...
     Modify collection of subfolders in given folder (or project, if parentFolderId=0).
                Depending on OperationType, different patch operations are executed.

                Currently supported:
                1) OperationType = BatchCreate
                Batch-create subfolders in given folders. Allows to create whole subtree with single
    call.
