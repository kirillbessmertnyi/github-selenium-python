...
from ...models.api_user_project_folder_assignment_patch_operation import ApiUserProjectFolderAssignmentPatchOperation
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiUserProjectFolderAssignmentPatchOperation,
    user_id: int,
...
def sync_detailed(
    ...
    *,
    ...
    """Modify user role assignment
     ...
     Modify user role assignment for the project or folder level.
