...
from ...models.api_project_patch_operation import ApiProjectPatchOperation
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiProjectPatchOperation,
) -> Dict[str, Any]:
    url = "{}/api/Project/{id}".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Update project
     ...
     Update project with the given id.

    Args:
        id (int):
        json_body (ApiProjectPatchOperation): Represents data required to execute project-modify
            operation.
