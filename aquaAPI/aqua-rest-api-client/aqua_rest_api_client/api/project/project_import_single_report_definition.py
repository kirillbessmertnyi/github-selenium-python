...
from ...models.project_import_single_report_definition_multipart_data import (
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: ProjectImportSingleReportDefinitionMultipartData,
    file_name: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/Project/{projectId}/ReportDefinition/Transfer".format(client.base_url, projectId=project_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Import report definition
     ...
     Direct import for a single report definition file.
