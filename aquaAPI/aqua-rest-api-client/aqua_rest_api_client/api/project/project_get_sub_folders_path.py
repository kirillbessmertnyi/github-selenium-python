...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Project/{projectId}/Folder/{folderId}/SubfolderPath".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get sub and parent folders as list
     ...
     Get subfolders of a given folder and all its parents up to the top (excluding root folder i.e.
    project level).
