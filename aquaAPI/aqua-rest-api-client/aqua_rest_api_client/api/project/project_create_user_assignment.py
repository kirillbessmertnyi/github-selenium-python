...
from ...models.api_user_project_folder_assignment import ApiUserProjectFolderAssignment
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiUserProjectFolderAssignment,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Create user role assignment
     ...
     Create a new user role assignment for the project or folder level.

    Args:
        project_id (int):
        json_body (ApiUserProjectFolderAssignment): The user project assignment.
