...
from ...models.api_project_template_dictionary_new import ApiProjectTemplateDictionaryNew
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiProjectTemplateDictionaryNew,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Create shared dictionary
     ...
     Create shared dictionary in the project with the given *projectId*.

    Args:
        project_id (int):
        json_body (ApiProjectTemplateDictionaryNew): Represents a new dictionary to be created.
