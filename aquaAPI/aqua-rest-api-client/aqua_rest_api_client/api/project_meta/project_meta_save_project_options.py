...
from ...models.api_project_options import ApiProjectOptions
...
def sync_detailed(
    ...
    *,
    ...
    """Replace setting options
     ...
     Replace options for the project with the given projectId.

    Args:
        project_id (int):
        json_body (ApiProjectOptions): Represents options of a certain project.
