...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiProjectTemplateDictionaryEntryNew,
) -> Dict[str, Any]:
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = ApiProjectTemplateDictionaryEntry.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Add dictionary entry
     ...
     Add a new entry to the specified dictionary field.
                Note that shared dictionaries cannot be extended with use of this method. Please use PUT
    /Project/{id}/Meta/SharedDictionary/{id} instead.
    ...
    Args:
        ...
        item_type (ApiItemType): Identifies the type of item.
            This enum has the following values:
              ...
              - `TestScenario`
        field_id (Optional[str]):
        json_body (ApiProjectTemplateDictionaryEntryNew): Contains the meta-information of a new
            dictionary entry.
    ...
    Returns:
        Response[Union[ApiArgumentError, ApiBackendNotAvailableError, ApiForbiddenError, ApiInternalError, ApiNotFoundError, ApiProjectTemplateDictionaryEntry, ApiUnauthorizedError]]
    """
