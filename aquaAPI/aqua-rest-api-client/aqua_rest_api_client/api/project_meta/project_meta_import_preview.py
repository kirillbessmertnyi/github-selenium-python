...
from ...models.api_import_project_template_preview_response import ApiImportProjectTemplatePreviewResponse
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/Project/{projectId}/Meta/Transfer/Preview".format(client.base_url, projectId=project_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = ApiImportProjectTemplatePreviewResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Import configuration preview
     ...
     Creates an import configuration preview for the project from the given file.
    ...
    Returns:
        Response[Union[ApiArgumentError, ApiBackendNotAvailableError, ApiForbiddenError, ApiImportProjectTemplatePreviewResponse, ApiInternalError, ApiNotFoundError, ApiUnauthorizedError]]
    """
