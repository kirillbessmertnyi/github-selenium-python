...
from ...models.api_project_field_rules_update import ApiProjectFieldRulesUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiProjectFieldRulesUpdate,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Update field rules
     ...
     Update the field rules for all item types in the project with the given
    ...
    Args:
        project_id (int):
        json_body (ApiProjectFieldRulesUpdate): Contains the modifications which should be applied
            to the field rules
