...
from ...models.project_meta_import_from_file_multipart_data import ProjectMetaImportFromFileMultipartData
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: ProjectMetaImportFromFileMultipartData,
