...
from ...models.api_field_rules_update import ApiFieldRulesUpdate
...
def sync_detailed(
    ...
    *,
    ...
    """Replace item type field rules
     ...
     Replace the field rules for the specified itemType in the project
    ...
    Args:
        ...
        item_type (ApiItemType): Identifies the type of item.
            This enum has the following values:
              ...
              - `TestExecution`
              - `TestScenario`
        json_body (ApiFieldRulesUpdate): Contains the modifications which should be applied to the
            field rules
