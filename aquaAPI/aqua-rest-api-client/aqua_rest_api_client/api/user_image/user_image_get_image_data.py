...
def _get_kwargs(
    *,
    ...
    initial_letters: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/UserImage/Data".format(client.base_url)

    headers: Dict[str, str] = client.get_headers()
    cookies: Dict[str, Any] = client.get_cookies()

    params: Dict[str, Any] = {}
    params["initialLetters"] = initial_letters
...
def sync_detailed(
    *,
    ...
    """Get user image
     ...
     Get or create the user image for the given *initialLetters*.

    Args:
        initial_letters (Union[Unset, None, str]):
