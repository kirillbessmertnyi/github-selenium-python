...
from ...models.api_item_export_request import ApiItemExportRequest
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiItemExportRequest,
) -> Dict[str, Any]:
    url = "{}/api/ExportItems/{projectId}/{folderId}".format(client.base_url, projectId=project_id, folderId=folder_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Export item to zipped Excel
     ...
     Exports all Items from a Folder to a Excel.
    Adds all Attach

    Args:
        project_id (int):
        folder_id (int):
        json_body (ApiItemExportRequest): Request for exporting files
