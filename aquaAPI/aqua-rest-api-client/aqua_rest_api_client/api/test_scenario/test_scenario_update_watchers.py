...
from ...models.api_watchers_update import ApiWatchersUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiWatchersUpdate,
) -> Dict[str, Any]:
    url = "{}/api/TestScenario/{id}/Watchers".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        json_body (ApiWatchersUpdate): Represents an update to the watchers list.
