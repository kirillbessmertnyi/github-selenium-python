...
def sync_detailed(
    ...
    *,
    ...
    """Replace post
     ...
     Replace the existing post with id postId in the testscenario with the given id.
                Users can be mentioned in the content with @UserName. The mentioned users
                will be extracted automatically. Only users which are members of the current
    testscenario
                can be mentioned.
