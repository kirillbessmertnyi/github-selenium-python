...
from ...models.api_test_scenario import ApiTestScenario
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = ApiTestScenario.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Get test scenario
     ...
     Get the test scenario with the specified *id*.
    ...
    Returns:
        Response[Union[ApiBackendNotAvailableError, ApiForbiddenError, ApiInternalError, ApiNotFoundError, ApiTestScenario, ApiUnauthorizedError]]
    """
