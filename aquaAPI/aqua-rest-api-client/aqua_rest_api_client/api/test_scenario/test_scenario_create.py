...
from ...models.api_item_new_with_test_jobs import ApiItemNewWithTestJobs
...
def _get_kwargs(
    *,
    ...
    json_body: ApiItemNewWithTestJobs,
...
def sync_detailed(
    *,
    ...
    """Create test scenario
     ...
     Create a new test scenario with the given data and returns some basic information on
