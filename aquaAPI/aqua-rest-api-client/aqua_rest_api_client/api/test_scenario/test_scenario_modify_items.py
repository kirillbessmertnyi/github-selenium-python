...
from ...models.api_items_patch_request import ApiItemsPatchRequest
...
def _get_kwargs(
    *,
    ...
    json_body: ApiItemsPatchRequest,
) -> Dict[str, Any]:
    url = "{}/api/TestScenario".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Modify test scenario collection
     ...
     Batch operation that modifies test scenarios matching criteria given in the request.
                The actual modification is specified in the request as well (by providing proper
    subclass of ApiItemsPatchRequest)
                The operation is performed asynchronously.

    Args:
        json_body (ApiItemsPatchRequest): Represent a request to modify a bunch of items (of the
            same type).
