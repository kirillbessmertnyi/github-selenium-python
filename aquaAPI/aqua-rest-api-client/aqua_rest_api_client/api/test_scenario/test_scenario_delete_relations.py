...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/TestScenario/{id}/Relation/{relationId}".format(client.base_url, id=id, relationId=relation_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Delete relation
     ...
     Delete relation of the test scenario with the given *id* and *relationId*.
