...
def _get_kwargs(
    *,
    ...
    url = "{}/api/TestScenario/CreateMeta".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Get fields metadata
     ...
     Get a basic information on the fields of a new test scenario created in given project and folder.
