...
from ...models.api_sprint_update import ApiSprintUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ApiSprintUpdate,
) -> Dict[str, Any]:
    url = "{}/api/Agile/Sprint/{id}".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Update sprint
     ...
     Allows to update the sprint with the given *id*.

    Args:
        id (int):
        json_body (ApiSprintUpdate): Contains information to update a new sprint.
