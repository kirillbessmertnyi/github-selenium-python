...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = ApiSprint.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ApiArgumentError, ApiBackendNotAvailableError, ApiForbiddenError, ApiInternalError, ApiNotFoundError, ApiSprint, ApiUnauthorizedError]]
    """
