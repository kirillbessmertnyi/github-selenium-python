...
from ...models.api_item_list_request import ApiItemListRequest
...
def _get_kwargs(
    *,
    ...
    json_body: ApiItemListRequest,
) -> Dict[str, Any]:
    url = "{}/api/Agile/ItemList".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (ApiItemListRequest): Items list request with filtering, sorting, and paging
