...
T = TypeVar("T", bound="ApiAutomationScriptNotSupportedSave")


@attr.s(auto_attribs=True)
class ApiAutomationScriptNotSupportedSave:
    """
    Attributes:
        technology (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_automation_script_not_supported_save = cls(
            technology=technology,
            is_new=is_new,
        )

        api_automation_script_not_supported_save.additional_properties = d
        return api_automation_script_not_supported_save
