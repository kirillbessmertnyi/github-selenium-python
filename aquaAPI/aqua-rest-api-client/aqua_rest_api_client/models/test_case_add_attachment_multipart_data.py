...
T = TypeVar("T", bound="TestCaseAddAttachmentMultipartData")


@attr.s(auto_attribs=True)
class TestCaseAddAttachmentMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        test_case_add_attachment_multipart_data = cls(
            file=file,
        )

        test_case_add_attachment_multipart_data.additional_properties = d
        return test_case_add_attachment_multipart_data
