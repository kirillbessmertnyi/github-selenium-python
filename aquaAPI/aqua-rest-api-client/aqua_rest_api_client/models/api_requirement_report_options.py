...
T = TypeVar("T", bound="ApiRequirementReportOptions")


@attr.s(auto_attribs=True)
class ApiRequirementReportOptions:
    """
    Attributes:
        item_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_requirement_report_options = cls(
            item_type=item_type,
            path=path,
            filter_=filter_,
        ...
        api_requirement_report_options.additional_properties = d
        return api_requirement_report_options
