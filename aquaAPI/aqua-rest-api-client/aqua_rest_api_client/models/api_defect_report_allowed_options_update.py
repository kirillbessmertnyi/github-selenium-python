...
T = TypeVar("T", bound="ApiDefectReportAllowedOptionsUpdate")


@attr.s(auto_attribs=True)
class ApiDefectReportAllowedOptionsUpdate:
    """
    Attributes:
        item_type (str):
        ...
        include_related_executions (Union[Unset, ApiAllowedOption]): Represents possible values for the report option.
            This enum has the following values:
              - `AlwaysFalse` Always false.
              - `AlwaysTrue` Always true.
              - `AskUser` Ask user.
    ...
    include_related_executions: Union[Unset, ApiAllowedOption] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        include_related_executions: Union[Unset, str] = UNSET
        if not isinstance(self.include_related_executions, Unset):
            include_related_executions = self.include_related_executions.value
        ...
        if include_related_executions is not UNSET:
            field_dict["IncludeRelatedExecutions"] = include_related_executions
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _include_related_executions = d.pop("IncludeRelatedExecutions", UNSET)
        include_related_executions: Union[Unset, ApiAllowedOption]
        if isinstance(_include_related_executions, Unset):
            include_related_executions = UNSET
        else:
            include_related_executions = ApiAllowedOption(_include_related_executions)

        api_defect_report_allowed_options_update = cls(
            item_type=item_type,
            ...
            path=path,
            filter_=filter_,
            include_related_executions=include_related_executions,
        )

        api_defect_report_allowed_options_update.additional_properties = d
        return api_defect_report_allowed_options_update
