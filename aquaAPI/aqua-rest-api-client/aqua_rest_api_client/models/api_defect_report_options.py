...
T = TypeVar("T", bound="ApiDefectReportOptions")


@attr.s(auto_attribs=True)
class ApiDefectReportOptions:
    """
    Attributes:
        item_type (str):
        ...
        include_related_executions (Union[Unset, bool]): Option, include related executions.
    """
    ...
    include_related_executions: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        include_related_executions = self.include_related_executions
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        include_related_executions = d.pop("IncludeRelatedExecutions", UNSET)

        api_defect_report_options = cls(
            item_type=item_type,
            path=path,
            filter_=filter_,
        ...
        api_defect_report_options.additional_properties = d
        return api_defect_report_options
