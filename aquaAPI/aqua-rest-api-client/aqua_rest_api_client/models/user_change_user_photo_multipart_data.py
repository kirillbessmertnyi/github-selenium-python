...
T = TypeVar("T", bound="UserChangeUserPhotoMultipartData")


@attr.s(auto_attribs=True)
class UserChangeUserPhotoMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_change_user_photo_multipart_data = cls(
            file=file,
        )

        user_change_user_photo_multipart_data.additional_properties = d
        return user_change_user_photo_multipart_data
