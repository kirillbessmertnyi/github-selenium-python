...
T = TypeVar("T", bound="ApiUserViewColumnSortGroupUpdate")


@attr.s(auto_attribs=True)
class ApiUserViewColumnSortGroupUpdate:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_user_view_column_sort_group_update = cls(
            field_id=field_id,
            sort_order=sort_order,
            is_grouped=is_grouped,
        )

        return api_user_view_column_sort_group_update
