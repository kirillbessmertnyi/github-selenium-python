...
T = TypeVar("T", bound="ApiDependenciesPermissionSetPatchResponse")


@attr.s(auto_attribs=True)
class ApiDependenciesPermissionSetPatchResponse:
    """
    Attributes:
        operation_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_dependencies_permission_set_patch_response = cls(
            operation_type=operation_type,
            permissions_to_add=permissions_to_add,
        )

        api_dependencies_permission_set_patch_response.additional_properties = d
        return api_dependencies_permission_set_patch_response
