...
T = TypeVar("T", bound="RequirementAddAttachmentMultipartData")


@attr.s(auto_attribs=True)
class RequirementAddAttachmentMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        requirement_add_attachment_multipart_data = cls(
            file=file,
        )

        requirement_add_attachment_multipart_data.additional_properties = d
        return requirement_add_attachment_multipart_data
