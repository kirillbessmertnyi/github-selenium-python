...
T = TypeVar("T", bound="ProjectMetaImportFromFileMultipartData")


@attr.s(auto_attribs=True)
class ProjectMetaImportFromFileMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_meta_import_from_file_multipart_data = cls(
            file=file,
        )

        project_meta_import_from_file_multipart_data.additional_properties = d
        return project_meta_import_from_file_multipart_data
