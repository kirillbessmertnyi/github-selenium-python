...
from ..models.api_report_workbook_color_palette_compliance import ApiReportWorkbookColorPaletteCompliance
...
T = TypeVar("T", bound="ApiReportXlsPrintoutOptions")


@attr.s(auto_attribs=True)
class ApiReportXlsPrintoutOptions:
    """
    Attributes:
        ...
        suppress_256_columns_warning (Union[Unset, bool]): Whether to suppress the exception that raises when trying to
            export a document to an XLS file with more than 256 columns.
        suppress_65536_rows_warning (Union[Unset, bool]): Whether to suppress the exception that raises when trying to
            export a document to an XLS file with more than 65536 rows.
        workbook_color_palette_compliance (Union[Unset, ApiReportWorkbookColorPaletteCompliance]):
            This enum has the following values:
              - `AdjustColorsToDefaultPalette` Degrade the color values to match the 56 standard colors of the default
            workbook palette.
              - `ReducePaletteForExactColors` Keep the original color values, but include only the first 56 colors into the
            palette.
             Default: ApiReportWorkbookColorPaletteCompliance.REDUCEPALETTEFOREXACTCOLORS.
    """
    ...
    suppress_256_columns_warning: Union[Unset, bool] = False
    suppress_65536_rows_warning: Union[Unset, bool] = False
    workbook_color_palette_compliance: Union[Unset, ApiReportWorkbookColorPaletteCompliance] = (
        ApiReportWorkbookColorPaletteCompliance.REDUCEPALETTEFOREXACTCOLORS
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        suppress_256_columns_warning = self.suppress_256_columns_warning
        suppress_65536_rows_warning = self.suppress_65536_rows_warning
        workbook_color_palette_compliance: Union[Unset, str] = UNSET
        if not isinstance(self.workbook_color_palette_compliance, Unset):
            workbook_color_palette_compliance = self.workbook_color_palette_compliance.value
        ...
        if suppress_256_columns_warning is not UNSET:
            field_dict["Suppress256ColumnsWarning"] = suppress_256_columns_warning
        if suppress_65536_rows_warning is not UNSET:
            field_dict["Suppress65536RowsWarning"] = suppress_65536_rows_warning
        if workbook_color_palette_compliance is not UNSET:
            field_dict["WorkbookColorPaletteCompliance"] = workbook_color_palette_compliance
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        suppress_256_columns_warning = d.pop("Suppress256ColumnsWarning", UNSET)

        suppress_65536_rows_warning = d.pop("Suppress65536RowsWarning", UNSET)

        _workbook_color_palette_compliance = d.pop("WorkbookColorPaletteCompliance", UNSET)
        workbook_color_palette_compliance: Union[Unset, ApiReportWorkbookColorPaletteCompliance]
        if isinstance(_workbook_color_palette_compliance, Unset):
            workbook_color_palette_compliance = UNSET
        else:
            workbook_color_palette_compliance = ApiReportWorkbookColorPaletteCompliance(
                _workbook_color_palette_compliance
            )

        api_report_xls_printout_options = cls(
            ...
            suppress_256_columns_warning=suppress_256_columns_warning,
            suppress_65536_rows_warning=suppress_65536_rows_warning,
            workbook_color_palette_compliance=workbook_color_palette_compliance,
        )

        api_report_xls_printout_options.additional_properties = d
        return api_report_xls_printout_options
