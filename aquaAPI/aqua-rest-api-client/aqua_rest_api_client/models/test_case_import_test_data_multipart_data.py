...
T = TypeVar("T", bound="TestCaseImportTestDataMultipartData")


@attr.s(auto_attribs=True)
class TestCaseImportTestDataMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        test_case_import_test_data_multipart_data = cls(
            file=file,
        )

        test_case_import_test_data_multipart_data.additional_properties = d
        return test_case_import_test_data_multipart_data
