...
T = TypeVar("T", bound="ApiTestExecutionExtendedInfo")


@attr.s(auto_attribs=True)
class ApiTestExecutionExtendedInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_test_execution_extended_info = cls(
            id=id,
        ...
        api_test_execution_extended_info.additional_properties = d
        return api_test_execution_extended_info
