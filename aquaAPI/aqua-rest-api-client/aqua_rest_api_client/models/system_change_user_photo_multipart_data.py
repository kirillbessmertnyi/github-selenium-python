...
T = TypeVar("T", bound="SystemChangeUserPhotoMultipartData")


@attr.s(auto_attribs=True)
class SystemChangeUserPhotoMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        system_change_user_photo_multipart_data = cls(
            file=file,
        )

        system_change_user_photo_multipart_data.additional_properties = d
        return system_change_user_photo_multipart_data
