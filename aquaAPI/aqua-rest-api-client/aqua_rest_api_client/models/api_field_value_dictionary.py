...
T = TypeVar("T", bound="ApiFieldValueDictionary")


@attr.s(auto_attribs=True)
class ApiFieldValueDictionary:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_value_dictionary = cls(
            field_value_type=field_value_type,
            text=text,
            id=id,
        )

        api_field_value_dictionary.additional_properties = d
        return api_field_value_dictionary
