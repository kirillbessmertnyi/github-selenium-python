...
if TYPE_CHECKING:
    ...
    from ..models.api_field_meta_dictionary_entry import ApiFieldMetaDictionaryEntry


T = TypeVar("T", bound="ApiFieldMetaDictionaryMultiChoice")


@attr.s(auto_attribs=True)
class ApiFieldMetaDictionaryMultiChoice:
    """
    Attributes:
        field_type (str):
        ...
        edit_meta (Union[Unset, None, ApiFieldEditMeta]): Contains the information for a specific field of an item
            including
            the field's value.
        entries (Union[Unset, None, List['ApiFieldMetaDictionaryEntry']]): Dictionary entries.
        is_shared (Union[Unset, bool]): Indicates if the field value set is shared.
    """
    ...
    entries: Union[Unset, None, List["ApiFieldMetaDictionaryEntry"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for entries_item_data in _entries or []:
            entries_item = ApiFieldMetaDictionaryEntry.from_dict(entries_item_data)

            entries.append(entries_item)

        is_shared = d.pop("IsShared", UNSET)

        api_field_meta_dictionary_multi_choice = cls(
        ...
        api_field_meta_dictionary_multi_choice.additional_properties = d
        return api_field_meta_dictionary_multi_choice
