...
if TYPE_CHECKING:
    ...
    from ..models.api_report_rtf_printout_options import ApiReportRtfPrintoutOptions


T = TypeVar("T", bound="ApiReportPrintoutRequestRtf")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestRtf:
    """
    Attributes:
        ...
        rtf_options (Union[Unset, None, ApiReportRtfPrintoutOptions]):
    """
    ...
    rtf_options: Union[Unset, None, "ApiReportRtfPrintoutOptions"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        rtf_options: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.rtf_options, Unset):
            rtf_options = self.rtf_options.to_dict() if self.rtf_options else None
        ...
        if rtf_options is not UNSET:
            field_dict["RtfOptions"] = rtf_options
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _rtf_options = d.pop("RtfOptions", UNSET)
        rtf_options: Union[Unset, None, ApiReportRtfPrintoutOptions]
        if _rtf_options is None:
            rtf_options = None
        elif isinstance(_rtf_options, Unset):
            rtf_options = UNSET
        else:
            rtf_options = ApiReportRtfPrintoutOptions.from_dict(_rtf_options)

        api_report_printout_request_rtf = cls(
            file_type=file_type,
            report_id=report_id,
            ...
            rtf_options=rtf_options,
        )

        api_report_printout_request_rtf.additional_properties = d
        return api_report_printout_request_rtf
