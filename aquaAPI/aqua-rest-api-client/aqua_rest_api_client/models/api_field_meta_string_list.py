...
T = TypeVar("T", bound="ApiFieldMetaStringList")


@attr.s(auto_attribs=True)
class ApiFieldMetaStringList:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_string_list = cls(
        ...
        api_field_meta_string_list.additional_properties = d
        return api_field_meta_string_list
