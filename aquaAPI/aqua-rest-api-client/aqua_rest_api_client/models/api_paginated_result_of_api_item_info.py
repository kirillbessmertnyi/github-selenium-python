...
T = TypeVar("T", bound="ApiPaginatedResultOfApiItemInfo")


@attr.s(auto_attribs=True)
class ApiPaginatedResultOfApiItemInfo:
    ...
    Attributes:
        ...
        items (Union[Unset, None, List['ApiItemInfo']]): The actual items included in this response.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_paginated_result_of_api_item_info = cls(
            start_at=start_at,
        ...
        return api_paginated_result_of_api_item_info
