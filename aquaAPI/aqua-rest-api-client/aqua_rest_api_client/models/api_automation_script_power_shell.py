...
T = TypeVar("T", bound="ApiAutomationScriptPowerShell")


@attr.s(auto_attribs=True)
class ApiAutomationScriptPowerShell:
    """
    Attributes:
        technology (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_automation_script_power_shell = cls(
            technology=technology,
        ...
        api_automation_script_power_shell.additional_properties = d
        return api_automation_script_power_shell
