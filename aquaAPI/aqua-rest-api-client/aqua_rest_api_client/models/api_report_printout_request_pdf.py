...
if TYPE_CHECKING:
    ...
    from ..models.api_report_pdf_printout_options import ApiReportPdfPrintoutOptions


T = TypeVar("T", bound="ApiReportPrintoutRequestPdf")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestPdf:
    """
    Attributes:
        ...
        pdf_options (Union[Unset, None, ApiReportPdfPrintoutOptions]):
    """
    ...
    pdf_options: Union[Unset, None, "ApiReportPdfPrintoutOptions"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        pdf_options: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.pdf_options, Unset):
            pdf_options = self.pdf_options.to_dict() if self.pdf_options else None
        ...
        if pdf_options is not UNSET:
            field_dict["PdfOptions"] = pdf_options
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _pdf_options = d.pop("PdfOptions", UNSET)
        pdf_options: Union[Unset, None, ApiReportPdfPrintoutOptions]
        if _pdf_options is None:
            pdf_options = None
        elif isinstance(_pdf_options, Unset):
            pdf_options = UNSET
        else:
            pdf_options = ApiReportPdfPrintoutOptions.from_dict(_pdf_options)

        api_report_printout_request_pdf = cls(
            file_type=file_type,
            report_id=report_id,
        ...
        api_report_printout_request_pdf.additional_properties = d
        return api_report_printout_request_pdf
