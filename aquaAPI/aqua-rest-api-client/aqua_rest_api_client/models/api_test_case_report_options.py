...
T = TypeVar("T", bound="ApiTestCaseReportOptions")


@attr.s(auto_attribs=True)
class ApiTestCaseReportOptions:
    """
    Attributes:
        item_type (str):
        ...
        include_test_steps (Union[Unset, bool]): Option, include test steps.
        include_executions (Union[Unset, bool]): Option, include executions.
        include_test_data (Union[Unset, bool]): Option, include test data.
    """
    ...
    include_test_steps: Union[Unset, bool] = UNSET
    include_executions: Union[Unset, bool] = UNSET
    include_test_data: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        include_test_steps = self.include_test_steps
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        include_test_steps = d.pop("IncludeTestSteps", UNSET)

        include_executions = d.pop("IncludeExecutions", UNSET)

        include_test_data = d.pop("IncludeTestData", UNSET)

        api_test_case_report_options = cls(
            item_type=item_type,
            path=path,
            filter_=filter_,
        ...
        api_test_case_report_options.additional_properties = d
        return api_test_case_report_options
