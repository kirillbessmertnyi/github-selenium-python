...
T = TypeVar("T", bound="ApiLongOperationOfBoolean")


@attr.s(auto_attribs=True)
class ApiLongOperationOfBoolean:
    ...
    Then the actual result is returned in Result field.
        ...
        Attributes:
            long_running_task_guid (Union[Unset, None, str]): Id of the long running task. Can be used to query the progress
                ...
                Result field.
            result (Union[Unset, bool]): Filled only when LongRunningTaskGuid is not provided. Contains actual, immediate
                result of the call.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_long_operation_of_boolean = cls(
            long_running_task_guid=long_running_task_guid,
            result=result,
        )

        return api_long_operation_of_boolean
