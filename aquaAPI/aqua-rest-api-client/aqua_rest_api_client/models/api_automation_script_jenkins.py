...
T = TypeVar("T", bound="ApiAutomationScriptJenkins")


@attr.s(auto_attribs=True)
class ApiAutomationScriptJenkins:
    """
    Attributes:
        technology (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_automation_script_jenkins = cls(
            technology=technology,
        ...
        api_automation_script_jenkins.additional_properties = d
        return api_automation_script_jenkins
