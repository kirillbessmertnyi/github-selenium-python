...
T = TypeVar("T", bound="ApiReportPrintoutRequestFile")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestFile:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_report_printout_request_file = cls(
            file_type=file_type,
            report_id=report_id,
        ...
        api_report_printout_request_file.additional_properties = d
        return api_report_printout_request_file
