...
T = TypeVar("T", bound="ApiFieldMetaDateTime")


@attr.s(auto_attribs=True)
class ApiFieldMetaDateTime:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_date_time.additional_properties = d
        return api_field_meta_date_time
