...
T = TypeVar("T", bound="ApiTestDataValueSetNew")


@attr.s(auto_attribs=True)
class ApiTestDataValueSetNew:
    """Contains information about new value set (along with values)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_test_data_value_set_new = cls(
            value_set_name=value_set_name,
            variables=variables,
        )

        return api_test_data_value_set_new
