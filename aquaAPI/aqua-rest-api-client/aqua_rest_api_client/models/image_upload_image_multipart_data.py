...
T = TypeVar("T", bound="ImageUploadImageMultipartData")


@attr.s(auto_attribs=True)
class ImageUploadImageMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        image_upload_image_multipart_data = cls(
            file=file,
        )

        image_upload_image_multipart_data.additional_properties = d
        return image_upload_image_multipart_data
