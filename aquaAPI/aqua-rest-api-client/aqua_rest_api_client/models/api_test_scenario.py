...
from ..models.api_test_scenario_run_status import ApiTestScenarioRunStatus
...
T = TypeVar("T", bound="ApiTestScenario")
...
class ApiTestScenario:
    ...
    Attributes:
        ...
        description (Union[Unset, None, ApiRichText]): Contains some rich text. The rich text is provided in several
            ...
            one format.
        has_test_cases (Union[Unset, bool]): True if test scenario has at least one test case.
        last_execution_status (Union[Unset, ApiTestScenarioRunStatus]):
            This enum has the following values:
        ...
        has_executions (Union[Unset, bool]): True if test scenario has at least one execution.
    """
    ...
    has_test_cases: Union[Unset, bool] = UNSET
    last_execution_status: Union[Unset, ApiTestScenarioRunStatus] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        has_test_cases = self.has_test_cases
        ...
        if has_test_cases is not UNSET:
            field_dict["HasTestCases"] = has_test_cases
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        has_test_cases = d.pop("HasTestCases", UNSET)
        ...
        if isinstance(_last_execution_status, Unset):
            ...
            last_execution_status = ApiTestScenarioRunStatus(_last_execution_status)

        has_executions = d.pop("HasExecutions", UNSET)

        api_test_scenario = cls(
            id=id,
        ...
        api_test_scenario.additional_properties = d
        return api_test_scenario
