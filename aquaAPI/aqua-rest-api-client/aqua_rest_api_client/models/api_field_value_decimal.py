...
T = TypeVar("T", bound="ApiFieldValueDecimal")


@attr.s(auto_attribs=True)
class ApiFieldValueDecimal:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_value_decimal = cls(
            field_value_type=field_value_type,
            text=text,
            value=value,
        )

        api_field_value_decimal.additional_properties = d
        return api_field_value_decimal
