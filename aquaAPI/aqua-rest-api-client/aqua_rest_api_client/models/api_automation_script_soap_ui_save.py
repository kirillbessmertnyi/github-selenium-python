...
T = TypeVar("T", bound="ApiAutomationScriptSoapUISave")


@attr.s(auto_attribs=True)
class ApiAutomationScriptSoapUISave:
    """
    Attributes:
        technology (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_automation_script_soap_ui_save = cls(
            technology=technology,
            is_new=is_new,
        )

        api_automation_script_soap_ui_save.additional_properties = d
        return api_automation_script_soap_ui_save
