...
if TYPE_CHECKING:
    ...
    from ..models.api_report_csv_printout_options import ApiReportCsvPrintoutOptions
    from ..models.api_report_parameter_value import ApiReportParameterValue


T = TypeVar("T", bound="ApiReportPrintoutRequestCsv")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestCsv:
    """
    Attributes:
        ...
        csv_options (Union[Unset, None, ApiReportCsvPrintoutOptions]):
    """
    ...
    csv_options: Union[Unset, None, "ApiReportCsvPrintoutOptions"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        csv_options: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.csv_options, Unset):
            csv_options = self.csv_options.to_dict() if self.csv_options else None
        ...
        if csv_options is not UNSET:
            field_dict["CsvOptions"] = csv_options
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _csv_options = d.pop("CsvOptions", UNSET)
        csv_options: Union[Unset, None, ApiReportCsvPrintoutOptions]
        if _csv_options is None:
            csv_options = None
        elif isinstance(_csv_options, Unset):
            csv_options = UNSET
        else:
            csv_options = ApiReportCsvPrintoutOptions.from_dict(_csv_options)

        api_report_printout_request_csv = cls(
            file_type=file_type,
            report_id=report_id,
        ...
        api_report_printout_request_csv.additional_properties = d
        return api_report_printout_request_csv
