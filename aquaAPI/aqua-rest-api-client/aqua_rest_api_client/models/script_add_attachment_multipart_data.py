...
T = TypeVar("T", bound="ScriptAddAttachmentMultipartData")


@attr.s(auto_attribs=True)
class ScriptAddAttachmentMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        script_add_attachment_multipart_data = cls(
            file=file,
        )

        script_add_attachment_multipart_data.additional_properties = d
        return script_add_attachment_multipart_data
