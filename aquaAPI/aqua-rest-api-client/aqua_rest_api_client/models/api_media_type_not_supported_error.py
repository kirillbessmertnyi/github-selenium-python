...
T = TypeVar("T", bound="ApiMediaTypeNotSupportedError")


@attr.s(auto_attribs=True)
class ApiMediaTypeNotSupportedError:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_media_type_not_supported_error = cls(
            message=message,
            code=code,
            type=type,
        ...
        api_media_type_not_supported_error.additional_properties = d
        return api_media_type_not_supported_error
