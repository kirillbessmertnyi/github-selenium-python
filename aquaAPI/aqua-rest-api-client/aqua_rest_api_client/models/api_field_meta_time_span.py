...
T = TypeVar("T", bound="ApiFieldMetaTimeSpan")


@attr.s(auto_attribs=True)
class ApiFieldMetaTimeSpan:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_time_span.additional_properties = d
        return api_field_meta_time_span
