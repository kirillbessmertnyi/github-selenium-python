...
T = TypeVar("T", bound="ApiFieldMetaDecimal")


@attr.s(auto_attribs=True)
class ApiFieldMetaDecimal:
    """
    Attributes:
        field_type (str):
        ...
        edit_meta (Union[Unset, None, ApiFieldEditMeta]): Contains the information for a specific field of an item
            including
            the field's value.
        field_mask (Union[Unset, None, str]): Field mask
        min_ (Union[Unset, None, float]): Minimum allowed field value (if defined)
        max_ (Union[Unset, None, float]): Maximum allowed field value (if defined)
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_decimal.additional_properties = d
        return api_field_meta_decimal
