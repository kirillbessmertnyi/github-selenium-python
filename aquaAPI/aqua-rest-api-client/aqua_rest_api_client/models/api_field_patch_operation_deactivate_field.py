...
T = TypeVar("T", bound="ApiFieldPatchOperationDeactivateField")


@attr.s(auto_attribs=True)
class ApiFieldPatchOperationDeactivateField:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_patch_operation_deactivate_field = cls(
            field_id=field_id,
            patch_operation=patch_operation,
            item_type=item_type,
        )

        api_field_patch_operation_deactivate_field.additional_properties = d
        return api_field_patch_operation_deactivate_field
