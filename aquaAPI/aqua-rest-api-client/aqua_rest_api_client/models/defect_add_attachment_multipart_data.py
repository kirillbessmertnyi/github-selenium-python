...
T = TypeVar("T", bound="DefectAddAttachmentMultipartData")


@attr.s(auto_attribs=True)
class DefectAddAttachmentMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        defect_add_attachment_multipart_data = cls(
            file=file,
        )

        defect_add_attachment_multipart_data.additional_properties = d
        return defect_add_attachment_multipart_data
