...
T = TypeVar("T", bound="ApiDependenciesRemoveSinglePermissionPatchRequest")


@attr.s(auto_attribs=True)
class ApiDependenciesRemoveSinglePermissionPatchRequest:
    """
    Attributes:
        operation_type (str):
        all_permissions (Union[Unset, None, List[ApiPermission]]): List of permissions to validate.
        removed_permission (Union[Unset, ApiPermission]): Represention of possible permissions.
    ...
    removed_permission: Union[Unset, ApiPermission] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        removed_permission: Union[Unset, str] = UNSET
        if not isinstance(self.removed_permission, Unset):
            removed_permission = self.removed_permission.value
        ...
        if removed_permission is not UNSET:
            field_dict["RemovedPermission"] = removed_permission
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _removed_permission = d.pop("RemovedPermission", UNSET)
        removed_permission: Union[Unset, ApiPermission]
        if isinstance(_removed_permission, Unset):
            removed_permission = UNSET
        else:
            removed_permission = ApiPermission(_removed_permission)

        api_dependencies_remove_single_permission_patch_request = cls(
            operation_type=operation_type,
            all_permissions=all_permissions,
            removed_permission=removed_permission,
        )

        api_dependencies_remove_single_permission_patch_request.additional_properties = d
        return api_dependencies_remove_single_permission_patch_request
