...
T = TypeVar("T", bound="ApiLongOperationInfo")


@attr.s(auto_attribs=True)
class ApiLongOperationInfo:
    """
    Attributes:
        info_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_long_operation_info.additional_properties = d
        return api_long_operation_info
