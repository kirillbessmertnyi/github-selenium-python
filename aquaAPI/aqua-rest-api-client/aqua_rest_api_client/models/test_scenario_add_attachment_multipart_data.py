...
T = TypeVar("T", bound="TestScenarioAddAttachmentMultipartData")


@attr.s(auto_attribs=True)
class TestScenarioAddAttachmentMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        test_scenario_add_attachment_multipart_data = cls(
            file=file,
        )

        test_scenario_add_attachment_multipart_data.additional_properties = d
        return test_scenario_add_attachment_multipart_data
