...
T = TypeVar("T", bound="ApiBaseObjectReportAllowedOptionsUpdate")


@attr.s(auto_attribs=True)
class ApiBaseObjectReportAllowedOptionsUpdate:
    """Represents the update information for base report allowed options.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_base_object_report_allowed_options_update = cls(
            item_type=item_type,
        ...
        return api_base_object_report_allowed_options_update
