...
T = TypeVar("T", bound="ApiTestDataNewReferencedTestCase")


@attr.s(auto_attribs=True)
class ApiTestDataNewReferencedTestCase:
    """
    Attributes:
        variant (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_test_data_new_referenced_test_case = cls(
            variant=variant,
            referenced_test_case_id=referenced_test_case_id,
        )

        api_test_data_new_referenced_test_case.additional_properties = d
        return api_test_data_new_referenced_test_case
