...
T = TypeVar("T", bound="ApiFieldMetaTestJobStatistics")


@attr.s(auto_attribs=True)
class ApiFieldMetaTestJobStatistics:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_test_job_statistics = cls(
        ...
        api_field_meta_test_job_statistics.additional_properties = d
        return api_field_meta_test_job_statistics
