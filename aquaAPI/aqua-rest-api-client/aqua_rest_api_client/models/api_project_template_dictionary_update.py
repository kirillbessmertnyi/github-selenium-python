...
T = TypeVar("T", bound="ApiProjectTemplateDictionaryUpdate")


@attr.s(auto_attribs=True)
class ApiProjectTemplateDictionaryUpdate:
    """Represents an update of single dictionary (i.e. entity that has a name and holds list of values) defined in the
    project template.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_project_template_dictionary_update = cls(
            entries=entries,
            id=id,
            name=name,
        ...
        return api_project_template_dictionary_update
