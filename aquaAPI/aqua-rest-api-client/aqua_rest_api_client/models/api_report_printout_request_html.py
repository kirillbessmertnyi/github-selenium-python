...
if TYPE_CHECKING:
    ...
    from ..models.api_report_html_printout_options import ApiReportHtmlPrintoutOptions
    from ..models.api_report_parameter_value import ApiReportParameterValue


T = TypeVar("T", bound="ApiReportPrintoutRequestHtml")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestHtml:
    """
    Attributes:
        ...
        html_options (Union[Unset, None, ApiReportHtmlPrintoutOptions]):
    """
    ...
    html_options: Union[Unset, None, "ApiReportHtmlPrintoutOptions"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        html_options: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.html_options, Unset):
            html_options = self.html_options.to_dict() if self.html_options else None
        ...
        if html_options is not UNSET:
            field_dict["HtmlOptions"] = html_options
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _html_options = d.pop("HtmlOptions", UNSET)
        html_options: Union[Unset, None, ApiReportHtmlPrintoutOptions]
        if _html_options is None:
            html_options = None
        elif isinstance(_html_options, Unset):
            html_options = UNSET
        else:
            html_options = ApiReportHtmlPrintoutOptions.from_dict(_html_options)

        api_report_printout_request_html = cls(
            file_type=file_type,
            report_id=report_id,
        ...
        api_report_printout_request_html.additional_properties = d
        return api_report_printout_request_html
