...
T = TypeVar("T", bound="ApiFieldValueString")


@attr.s(auto_attribs=True)
class ApiFieldValueString:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_value_string = cls(
            field_value_type=field_value_type,
            text=text,
        )

        api_field_value_string.additional_properties = d
        return api_field_value_string
