...
T = TypeVar("T", bound="ApiTestExecutionPatchCancel")


@attr.s(auto_attribs=True)
class ApiTestExecutionPatchCancel:
    """
    Attributes:
        patch_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_test_execution_patch_cancel = cls(
            patch_type=patch_type,
            test_executions_ids=test_executions_ids,
        )

        api_test_execution_patch_cancel.additional_properties = d
        return api_test_execution_patch_cancel
