...
T = TypeVar("T", bound="ApiReportHtmlPrintoutOptions")


@attr.s(auto_attribs=True)
class ApiReportHtmlPrintoutOptions:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_report_html_printout_options = cls(
        ...
        return api_report_html_printout_options
