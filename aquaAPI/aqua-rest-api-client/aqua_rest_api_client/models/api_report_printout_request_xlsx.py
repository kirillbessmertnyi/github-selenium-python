...
if TYPE_CHECKING:
    ...
    from ..models.api_report_xlsx_printout_options import ApiReportXlsxPrintoutOptions


T = TypeVar("T", bound="ApiReportPrintoutRequestXlsx")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestXlsx:
    """
    Attributes:
        ...
        xlsx_options (Union[Unset, None, ApiReportXlsxPrintoutOptions]):
    """
    ...
    xlsx_options: Union[Unset, None, "ApiReportXlsxPrintoutOptions"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        xlsx_options: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.xlsx_options, Unset):
            xlsx_options = self.xlsx_options.to_dict() if self.xlsx_options else None
        ...
        if xlsx_options is not UNSET:
            field_dict["XlsxOptions"] = xlsx_options
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _xlsx_options = d.pop("XlsxOptions", UNSET)
        xlsx_options: Union[Unset, None, ApiReportXlsxPrintoutOptions]
        if _xlsx_options is None:
            xlsx_options = None
        elif isinstance(_xlsx_options, Unset):
            xlsx_options = UNSET
        else:
            xlsx_options = ApiReportXlsxPrintoutOptions.from_dict(_xlsx_options)

        api_report_printout_request_xlsx = cls(
            file_type=file_type,
            report_id=report_id,
        ...
        api_report_printout_request_xlsx.additional_properties = d
        return api_report_printout_request_xlsx
