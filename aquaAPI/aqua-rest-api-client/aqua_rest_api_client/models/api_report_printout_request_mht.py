...
if TYPE_CHECKING:
    ...
    from ..models.api_report_mht_printout_options import ApiReportMhtPrintoutOptions
    from ..models.api_report_parameter_value import ApiReportParameterValue


T = TypeVar("T", bound="ApiReportPrintoutRequestMht")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestMht:
    """
    Attributes:
        ...
        mht_options (Union[Unset, None, ApiReportMhtPrintoutOptions]):
    """
    ...
    mht_options: Union[Unset, None, "ApiReportMhtPrintoutOptions"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        mht_options: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.mht_options, Unset):
            mht_options = self.mht_options.to_dict() if self.mht_options else None
        ...
        if mht_options is not UNSET:
            field_dict["MhtOptions"] = mht_options
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _mht_options = d.pop("MhtOptions", UNSET)
        mht_options: Union[Unset, None, ApiReportMhtPrintoutOptions]
        if _mht_options is None:
            mht_options = None
        elif isinstance(_mht_options, Unset):
            mht_options = UNSET
        else:
            mht_options = ApiReportMhtPrintoutOptions.from_dict(_mht_options)

        api_report_printout_request_mht = cls(
            file_type=file_type,
            report_id=report_id,
            ...
            mht_options=mht_options,
        )

        api_report_printout_request_mht.additional_properties = d
        return api_report_printout_request_mht
