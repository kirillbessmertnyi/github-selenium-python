...
T = TypeVar("T", bound="ApiFieldMetaString")


@attr.s(auto_attribs=True)
class ApiFieldMetaString:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_string.additional_properties = d
        return api_field_meta_string
