...
T = TypeVar("T", bound="ApiFieldRuleWorkflowActionsUpdate")


@attr.s(auto_attribs=True)
class ApiFieldRuleWorkflowActionsUpdate:
    ...
    Attributes:
        ...
        visible (bool): Indicates whether the field should be highlighted.
        highlight (bool): Indicates whether the field should be visible.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_rule_workflow_actions_update = cls(
            field_id=field_id,
            readonly=readonly,
            required=required,
            visible=visible,
        ...
        return api_field_rule_workflow_actions_update
