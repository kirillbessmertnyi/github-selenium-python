...
if TYPE_CHECKING:
    ...
    from ..models.api_nested_test_case_info_new import ApiNestedTestCaseInfoNew
    from ..models.api_rich_text import ApiRichText


T = TypeVar("T", bound="ApiTestStepNew")


@attr.s(auto_attribs=True)
class ApiTestStepNew:
    """
    Attributes:
        ...
        nested_test_case (Union[Unset, None, ApiNestedTestCaseInfoNew]): Contains information about nested test case.
    """
    ...
    nested_test_case: Union[Unset, None, "ApiNestedTestCaseInfoNew"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nested_test_case: Union[Unset, None, ApiNestedTestCaseInfoNew]
        if _nested_test_case is None:
            nested_test_case = None
        elif isinstance(_nested_test_case, Unset):
            nested_test_case = UNSET
        else:
            nested_test_case = ApiNestedTestCaseInfoNew.from_dict(_nested_test_case)

        api_test_step_new = cls(
            name=name,
            index=index,
        ...
        api_test_step_new.additional_properties = d
        return api_test_step_new
