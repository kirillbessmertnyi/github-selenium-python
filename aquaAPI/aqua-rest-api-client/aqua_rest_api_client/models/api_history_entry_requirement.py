...
if TYPE_CHECKING:
    ...
    from ..models.api_history_subrequirements import ApiHistorySubrequirements
...
T = TypeVar("T", bound="ApiHistoryEntryRequirement")


@attr.s(auto_attribs=True)
class ApiHistoryEntryRequirement:
    """
    Attributes:
        ...
        migrated (Union[Unset, None, ApiHistoryItemMigrated]): Information on the migration of the item from a third-
            party system.
        subrequirements (Union[Unset, None, ApiHistorySubrequirements]): The list of changes to the sub requirements of
            a requirement.
    """
    ...
    subrequirements: Union[Unset, None, "ApiHistorySubrequirements"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        subrequirements: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.subrequirements, Unset):
            subrequirements = self.subrequirements.to_dict() if self.subrequirements else None
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrequirements: Union[Unset, None, ApiHistorySubrequirements]
        if _subrequirements is None:
            subrequirements = None
        elif isinstance(_subrequirements, Unset):
            subrequirements = UNSET
        else:
            subrequirements = ApiHistorySubrequirements.from_dict(_subrequirements)

        api_history_entry_requirement = cls(
            id=id,
        ...
        api_history_entry_requirement.additional_properties = d
        return api_history_entry_requirement
