...
T = TypeVar("T", bound="ApiFieldMetaSprint")


@attr.s(auto_attribs=True)
class ApiFieldMetaSprint:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_sprint.additional_properties = d
        return api_field_meta_sprint
