...
T = TypeVar("T", bound="ApiItemNewWithDescription")


@attr.s(auto_attribs=True)
class ApiItemNewWithDescription:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_item_new_with_description = cls(
            location=location,
            details=details,
        ...
        api_item_new_with_description.additional_properties = d
        return api_item_new_with_description
