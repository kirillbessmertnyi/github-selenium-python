...
T = TypeVar("T", bound="ApiIntegrationConfigUpdateJira")


@attr.s(auto_attribs=True)
class ApiIntegrationConfigUpdateJira:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_integration_config_update_jira = cls(
        ...
        api_integration_config_update_jira.additional_properties = d
        return api_integration_config_update_jira
