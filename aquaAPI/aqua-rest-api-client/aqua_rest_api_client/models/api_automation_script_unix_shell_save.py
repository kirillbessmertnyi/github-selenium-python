...
T = TypeVar("T", bound="ApiAutomationScriptUnixShellSave")


@attr.s(auto_attribs=True)
class ApiAutomationScriptUnixShellSave:
    """
    Attributes:
        technology (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_automation_script_unix_shell_save = cls(
            technology=technology,
            is_new=is_new,
            new_files=new_files,
        ...
        api_automation_script_unix_shell_save.additional_properties = d
        return api_automation_script_unix_shell_save
