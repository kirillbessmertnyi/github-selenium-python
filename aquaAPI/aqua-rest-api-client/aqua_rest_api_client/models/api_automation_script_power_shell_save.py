...
T = TypeVar("T", bound="ApiAutomationScriptPowerShellSave")


@attr.s(auto_attribs=True)
class ApiAutomationScriptPowerShellSave:
    """
    Attributes:
        technology (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_automation_script_power_shell_save = cls(
            technology=technology,
            is_new=is_new,
            new_files=new_files,
        ...
        api_automation_script_power_shell_save.additional_properties = d
        return api_automation_script_power_shell_save
