...
T = TypeVar("T", bound="ApiPaginatedResultOfApiTestExecutionInfo")


@attr.s(auto_attribs=True)
class ApiPaginatedResultOfApiTestExecutionInfo:
    ...
    Attributes:
        ...
        items (Union[Unset, None, List['ApiTestExecutionInfo']]): The actual items included in this response.
    """

    start_at: Union[Unset, int] = UNSET
    max_results: Union[Unset, int] = UNSET
    count: Union[Unset, int] = UNSET
    items: Union[Unset, None, List["ApiTestExecutionInfo"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = ApiTestExecutionInfo.from_dict(items_item_data)

            items.append(items_item)

        api_paginated_result_of_api_test_execution_info = cls(
            start_at=start_at,
        ...
        return api_paginated_result_of_api_test_execution_info
