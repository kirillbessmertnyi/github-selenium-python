...
T = TypeVar("T", bound="ApiFieldMetaTestScenarios")


@attr.s(auto_attribs=True)
class ApiFieldMetaTestScenarios:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_test_scenarios = cls(
        ...
        api_field_meta_test_scenarios.additional_properties = d
        return api_field_meta_test_scenarios
