...
if TYPE_CHECKING:
    from ..models.api_config_element_entry_save import ApiConfigElementEntrySave


T = TypeVar("T", bound="ApiConfigElementSave")


@attr.s(auto_attribs=True)
class ApiConfigElementSave:
    """
    Attributes:
        ...
        entries (Union[Unset, None, List['ApiConfigElementEntrySave']]): Entries to be saved.
    """
    ...
    entries: Union[Unset, None, List["ApiConfigElementEntrySave"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for entries_item_data in _entries or []:
            entries_item = ApiConfigElementEntrySave.from_dict(entries_item_data)

            entries.append(entries_item)

        api_config_element_save = cls(
            data_path=data_path,
            locked=locked,
        ...
        api_config_element_save.additional_properties = d
        return api_config_element_save
