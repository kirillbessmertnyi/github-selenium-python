...
if TYPE_CHECKING:
    ...
    from ..models.api_report_text_printout_options import ApiReportTextPrintoutOptions


T = TypeVar("T", bound="ApiReportPrintoutRequestText")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestText:
    """
    Attributes:
        ...
        text_options (Union[Unset, None, ApiReportTextPrintoutOptions]):
    """
    ...
    text_options: Union[Unset, None, "ApiReportTextPrintoutOptions"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        text_options: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.text_options, Unset):
            text_options = self.text_options.to_dict() if self.text_options else None
        ...
        if text_options is not UNSET:
            field_dict["TextOptions"] = text_options
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _text_options = d.pop("TextOptions", UNSET)
        text_options: Union[Unset, None, ApiReportTextPrintoutOptions]
        if _text_options is None:
            text_options = None
        elif isinstance(_text_options, Unset):
            text_options = UNSET
        else:
            text_options = ApiReportTextPrintoutOptions.from_dict(_text_options)

        api_report_printout_request_text = cls(
            file_type=file_type,
            report_id=report_id,
        ...
        api_report_printout_request_text.additional_properties = d
        return api_report_printout_request_text
