...
T = TypeVar("T", bound="ApiItemLongOperationCopyInProject")


@attr.s(auto_attribs=True)
class ApiItemLongOperationCopyInProject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_item_long_operation_copy_in_project = cls(
            criteria=criteria,
            target_folder_id=target_folder_id,
        )

        return api_item_long_operation_copy_in_project
