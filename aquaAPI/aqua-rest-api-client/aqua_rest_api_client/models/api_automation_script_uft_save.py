...
T = TypeVar("T", bound="ApiAutomationScriptUFTSave")


@attr.s(auto_attribs=True)
class ApiAutomationScriptUFTSave:
    """
    Attributes:
        technology (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_automation_script_uft_save = cls(
            technology=technology,
            is_new=is_new,
        )

        api_automation_script_uft_save.additional_properties = d
        return api_automation_script_uft_save
