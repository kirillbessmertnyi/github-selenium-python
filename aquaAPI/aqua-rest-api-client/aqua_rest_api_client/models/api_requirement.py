...
T = TypeVar("T", bound="ApiRequirement")
...
class ApiRequirement:
    ...
    Attributes:
        ...
        description (Union[Unset, None, ApiRichText]): Contains some rich text. The rich text is provided in several
            ...
            one format.
        has_sub_requirements (Union[Unset, bool]): True if requirement has any sub requirements.
    """
    ...
    has_sub_requirements: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        has_sub_requirements = self.has_sub_requirements
        ...
        if has_sub_requirements is not UNSET:
            field_dict["HasSubRequirements"] = has_sub_requirements
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        has_sub_requirements = d.pop("HasSubRequirements", UNSET)
        ...
        api_requirement = cls(
            ...
            has_sub_requirements=has_sub_requirements,
        )

        api_requirement.additional_properties = d
