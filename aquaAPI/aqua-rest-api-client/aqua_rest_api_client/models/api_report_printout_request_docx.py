...
if TYPE_CHECKING:
    ...
    from ..models.api_report_docx_printout_options import ApiReportDocxPrintoutOptions
    from ..models.api_report_parameter_value import ApiReportParameterValue


T = TypeVar("T", bound="ApiReportPrintoutRequestDocx")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestDocx:
    """
    Attributes:
        ...
        docx_options (Union[Unset, None, ApiReportDocxPrintoutOptions]):
    """
    ...
    docx_options: Union[Unset, None, "ApiReportDocxPrintoutOptions"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        docx_options: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.docx_options, Unset):
            docx_options = self.docx_options.to_dict() if self.docx_options else None
        ...
        if docx_options is not UNSET:
            field_dict["DocxOptions"] = docx_options
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _docx_options = d.pop("DocxOptions", UNSET)
        docx_options: Union[Unset, None, ApiReportDocxPrintoutOptions]
        if _docx_options is None:
            docx_options = None
        elif isinstance(_docx_options, Unset):
            docx_options = UNSET
        else:
            docx_options = ApiReportDocxPrintoutOptions.from_dict(_docx_options)

        api_report_printout_request_docx = cls(
            file_type=file_type,
            report_id=report_id,
        ...
        api_report_printout_request_docx.additional_properties = d
        return api_report_printout_request_docx
