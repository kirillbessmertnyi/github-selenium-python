...
T = TypeVar("T", bound="ApiFieldMetaExecutionHistory")


@attr.s(auto_attribs=True)
class ApiFieldMetaExecutionHistory:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_execution_history = cls(
        ...
        api_field_meta_execution_history.additional_properties = d
        return api_field_meta_execution_history
