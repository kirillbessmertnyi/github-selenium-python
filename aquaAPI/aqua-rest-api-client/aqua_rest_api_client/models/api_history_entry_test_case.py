...
if TYPE_CHECKING:
    ...
    from ..models.api_history_test_data import ApiHistoryTestData
    from ..models.api_history_test_steps import ApiHistoryTestSteps
    from ..models.api_history_user_c_cs import ApiHistoryUserCCs
    from ..models.api_user_info import ApiUserInfo


T = TypeVar("T", bound="ApiHistoryEntryTestCase")


@attr.s(auto_attribs=True)
class ApiHistoryEntryTestCase:
    """
    Attributes:
        ...
        migrated (Union[Unset, None, ApiHistoryItemMigrated]): Information on the migration of the item from a third-
            party system.
        test_steps (Union[Unset, None, ApiHistoryTestSteps]): The list of changes to the test steps of a test case.
        test_data (Union[Unset, None, ApiHistoryTestData]): Represents changes in test data
    """
    ...
    test_steps: Union[Unset, None, "ApiHistoryTestSteps"] = UNSET
    test_data: Union[Unset, None, "ApiHistoryTestData"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        test_steps: Union[Unset, None, ApiHistoryTestSteps]
        if _test_steps is None:
            test_steps = None
        elif isinstance(_test_steps, Unset):
            test_steps = UNSET
        else:
            test_steps = ApiHistoryTestSteps.from_dict(_test_steps)

        _test_data = d.pop("TestData", UNSET)
        test_data: Union[Unset, None, ApiHistoryTestData]
        if _test_data is None:
            test_data = None
        elif isinstance(_test_data, Unset):
            test_data = UNSET
        else:
            test_data = ApiHistoryTestData.from_dict(_test_data)

        api_history_entry_test_case = cls(
            id=id,
        ...
        api_history_entry_test_case.additional_properties = d
        return api_history_entry_test_case
