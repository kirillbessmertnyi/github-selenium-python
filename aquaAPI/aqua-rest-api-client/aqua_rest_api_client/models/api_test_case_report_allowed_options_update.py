...
T = TypeVar("T", bound="ApiTestCaseReportAllowedOptionsUpdate")


@attr.s(auto_attribs=True)
class ApiTestCaseReportAllowedOptionsUpdate:
    """
    Attributes:
        item_type (str):
        ...
        include_test_steps (Union[Unset, ApiAllowedOption]): Represents possible values for the report option.
            This enum has the following values:
              - `AlwaysFalse` Always false.
              - `AlwaysTrue` Always true.
              - `AskUser` Ask user.
        include_executions (Union[Unset, ApiAllowedOption]): Represents possible values for the report option.
            This enum has the following values:
              ...
              - `AlwaysTrue` Always true.
              - `AskUser` Ask user.
        include_test_data (Union[Unset, ApiAllowedOption]): Represents possible values for the report option.
            This enum has the following values:
              - `AlwaysFalse` Always false.
              - `AlwaysTrue` Always true.
              - `AskUser` Ask user.
    ...
    include_test_steps: Union[Unset, ApiAllowedOption] = UNSET
    include_executions: Union[Unset, ApiAllowedOption] = UNSET
    include_test_data: Union[Unset, ApiAllowedOption] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        include_test_steps: Union[Unset, str] = UNSET
        if not isinstance(self.include_test_steps, Unset):
            include_test_steps = self.include_test_steps.value
        ...
        include_test_data: Union[Unset, str] = UNSET
        if not isinstance(self.include_test_data, Unset):
            include_test_data = self.include_test_data.value
        ...
        if include_test_steps is not UNSET:
            field_dict["IncludeTestSteps"] = include_test_steps
        if include_executions is not UNSET:
            field_dict["IncludeExecutions"] = include_executions
        if include_test_data is not UNSET:
            field_dict["IncludeTestData"] = include_test_data
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _include_test_steps = d.pop("IncludeTestSteps", UNSET)
        include_test_steps: Union[Unset, ApiAllowedOption]
        if isinstance(_include_test_steps, Unset):
            include_test_steps = UNSET
        else:
            include_test_steps = ApiAllowedOption(_include_test_steps)
        ...
        _include_test_data = d.pop("IncludeTestData", UNSET)
        include_test_data: Union[Unset, ApiAllowedOption]
        if isinstance(_include_test_data, Unset):
            include_test_data = UNSET
        else:
            include_test_data = ApiAllowedOption(_include_test_data)

        api_test_case_report_allowed_options_update = cls(
            item_type=item_type,
        ...
        api_test_case_report_allowed_options_update.additional_properties = d
        return api_test_case_report_allowed_options_update
