...
T = TypeVar("T", bound="ApiAutomationScriptShell")


@attr.s(auto_attribs=True)
class ApiAutomationScriptShell:
    """
    Attributes:
        technology (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_automation_script_shell = cls(
            technology=technology,
        ...
        api_automation_script_shell.additional_properties = d
        return api_automation_script_shell
