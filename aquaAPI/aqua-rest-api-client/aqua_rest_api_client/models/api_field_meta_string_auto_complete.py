...
T = TypeVar("T", bound="ApiFieldMetaStringAutoComplete")


@attr.s(auto_attribs=True)
class ApiFieldMetaStringAutoComplete:
    """
    Attributes:
        field_type (str):
        ...
        length (Union[Unset, int]): Maximum field length
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_string_auto_complete = cls(
        ...
        api_field_meta_string_auto_complete.additional_properties = d
        return api_field_meta_string_auto_complete
