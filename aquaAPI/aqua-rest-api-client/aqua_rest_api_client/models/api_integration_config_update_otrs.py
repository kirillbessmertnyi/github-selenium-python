...
T = TypeVar("T", bound="ApiIntegrationConfigUpdateOtrs")


@attr.s(auto_attribs=True)
class ApiIntegrationConfigUpdateOtrs:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_integration_config_update_otrs = cls(
        ...
        api_integration_config_update_otrs.additional_properties = d
        return api_integration_config_update_otrs
