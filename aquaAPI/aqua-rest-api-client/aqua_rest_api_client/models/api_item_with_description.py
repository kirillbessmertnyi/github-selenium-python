...
T = TypeVar("T", bound="ApiItemWithDescription")


@attr.s(auto_attribs=True)
class ApiItemWithDescription:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_item_with_description.additional_properties = d
        return api_item_with_description
