...
T = TypeVar("T", bound="ApiFieldMetaUserMultiChoice")


@attr.s(auto_attribs=True)
class ApiFieldMetaUserMultiChoice:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_user_multi_choice = cls(
        ...
        api_field_meta_user_multi_choice.additional_properties = d
        return api_field_meta_user_multi_choice
