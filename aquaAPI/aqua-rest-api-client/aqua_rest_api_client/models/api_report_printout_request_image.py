...
if TYPE_CHECKING:
    ...
    from ..models.api_report_image_printout_options import ApiReportImagePrintoutOptions
    from ..models.api_report_parameter_value import ApiReportParameterValue


T = TypeVar("T", bound="ApiReportPrintoutRequestImage")


@attr.s(auto_attribs=True)
class ApiReportPrintoutRequestImage:
    """
    Attributes:
        ...
        image_options (Union[Unset, None, ApiReportImagePrintoutOptions]):
    """
    ...
    image_options: Union[Unset, None, "ApiReportImagePrintoutOptions"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        image_options: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.image_options, Unset):
            image_options = self.image_options.to_dict() if self.image_options else None
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _image_options is None:
            image_options = None
        elif isinstance(_image_options, Unset):
            image_options = UNSET
        else:
            image_options = ApiReportImagePrintoutOptions.from_dict(_image_options)

        api_report_printout_request_image = cls(
            file_type=file_type,
            report_id=report_id,
        ...
        api_report_printout_request_image.additional_properties = d
        return api_report_printout_request_image
