...
class ApiDefect:
    ...
    Attributes:
        ...
        enclosures (Union[Unset, None, List['ApiEnclosure']]): Contains all defect enclosures
    """
    ...
    enclosures: Union[Unset, None, List["ApiEnclosure"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for enclosures_item_data in _enclosures or []:
            enclosures_item = ApiEnclosure.from_dict(enclosures_item_data)
        ...
        api_defect.additional_properties = d
        return api_defect
