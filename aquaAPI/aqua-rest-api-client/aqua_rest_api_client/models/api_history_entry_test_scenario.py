...
if TYPE_CHECKING:
    ...
    from ..models.api_history_test_jobs import ApiHistoryTestJobs
    from ..models.api_history_user_c_cs import ApiHistoryUserCCs
    from ..models.api_user_info import ApiUserInfo


T = TypeVar("T", bound="ApiHistoryEntryTestScenario")


@attr.s(auto_attribs=True)
class ApiHistoryEntryTestScenario:
    """
    Attributes:
        ...
        migrated (Union[Unset, None, ApiHistoryItemMigrated]): Information on the migration of the item from a third-
            party system.
        test_jobs (Union[Unset, None, ApiHistoryTestJobs]): The list of changes to the test jobs of a test scenario.
    """
    ...
    test_jobs: Union[Unset, None, "ApiHistoryTestJobs"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        test_jobs: Union[Unset, None, ApiHistoryTestJobs]
        if _test_jobs is None:
            test_jobs = None
        elif isinstance(_test_jobs, Unset):
            test_jobs = UNSET
        else:
            test_jobs = ApiHistoryTestJobs.from_dict(_test_jobs)

        api_history_entry_test_scenario = cls(
            id=id,
        ...
        api_history_entry_test_scenario.additional_properties = d
        return api_history_entry_test_scenario
