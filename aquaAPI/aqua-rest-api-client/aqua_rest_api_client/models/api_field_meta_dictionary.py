...
T = TypeVar("T", bound="ApiFieldMetaDictionary")


@attr.s(auto_attribs=True)
class ApiFieldMetaDictionary:
    """
    Attributes:
        field_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_field_meta_dictionary.additional_properties = d
        return api_field_meta_dictionary
