...
T = TypeVar("T", bound="ApiMethodNotAllowedError")
...
class ApiMethodNotAllowedError:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_method_not_allowed_error = cls(
            message=message,
            code=code,
            type=type,
        ...
        api_method_not_allowed_error.additional_properties = d
        return api_method_not_allowed_error
