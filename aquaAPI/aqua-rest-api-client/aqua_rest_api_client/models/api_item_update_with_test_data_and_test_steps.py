...
if TYPE_CHECKING:
    ...
    from ..models.api_test_data_update import ApiTestDataUpdate
    from ..models.api_test_steps_update import ApiTestStepsUpdate


T = TypeVar("T", bound="ApiItemUpdateWithTestDataAndTestSteps")


@attr.s(auto_attribs=True)
class ApiItemUpdateWithTestDataAndTestSteps:
    """
    Attributes:
        ...
        description (Union[Unset, None, ApiRichText]): Contains some rich text. The rich text is provided in several
            ...
            one format.
        test_data (Union[Unset, None, ApiTestDataUpdate]): Base class for updated test data of a test case.
            This class is abstract, not intended to be used directly.
        test_steps (Union[Unset, None, ApiTestStepsUpdate]): Contains a list of different changes which should be
            applied to the
    ...
    test_data: Union[Unset, None, "ApiTestDataUpdate"] = UNSET
    test_steps: Union[Unset, None, "ApiTestStepsUpdate"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        test_steps: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.test_steps, Unset):
            test_steps = self.test_steps.to_dict() if self.test_steps else None
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        test_data: Union[Unset, None, ApiTestDataUpdate]
        if _test_data is None:
            test_data = None
        elif isinstance(_test_data, Unset):
            test_data = UNSET
        else:
            test_data = ApiTestDataUpdate.from_dict(_test_data)

        _test_steps = d.pop("TestSteps", UNSET)
        test_steps: Union[Unset, None, ApiTestStepsUpdate]
        if _test_steps is None:
            test_steps = None
        elif isinstance(_test_steps, Unset):
            test_steps = UNSET
        else:
            test_steps = ApiTestStepsUpdate.from_dict(_test_steps)

        api_item_update_with_test_data_and_test_steps = cls(
            details=details,
        ...
        api_item_update_with_test_data_and_test_steps.additional_properties = d
        return api_item_update_with_test_data_and_test_steps
