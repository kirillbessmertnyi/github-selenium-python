...
T = TypeVar("T", bound="ApiBaseObjectReportOptions")


@attr.s(auto_attribs=True)
class ApiBaseObjectReportOptions:
    """Contains options affecting report generation on a given level (see Path property).
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_base_object_report_options = cls(
            item_type=item_type,
            path=path,
            filter_=filter_,
        ...
        return api_base_object_report_options
