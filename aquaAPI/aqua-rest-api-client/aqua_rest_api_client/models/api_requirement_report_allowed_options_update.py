...
T = TypeVar("T", bound="ApiRequirementReportAllowedOptionsUpdate")


@attr.s(auto_attribs=True)
class ApiRequirementReportAllowedOptionsUpdate:
    """
    Attributes:
        item_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_requirement_report_allowed_options_update = cls(
            item_type=item_type,
        ...
        api_requirement_report_allowed_options_update.additional_properties = d
        return api_requirement_report_allowed_options_update
