...
T = TypeVar("T", bound="TestCaseImportTestDataWithoutSaveMultipartData")


@attr.s(auto_attribs=True)
class TestCaseImportTestDataWithoutSaveMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        test_case_import_test_data_without_save_multipart_data = cls(
            file=file,
        )

        test_case_import_test_data_without_save_multipart_data.additional_properties = d
        return test_case_import_test_data_without_save_multipart_data
